...
Besides, VlnPlot() and FeaturePlot() failed to give plot(s) on some genes in the scaled data, while TidyGenePlot fixed this bug, which could be an helpful information to whom working on scRNA-seq analysis.
